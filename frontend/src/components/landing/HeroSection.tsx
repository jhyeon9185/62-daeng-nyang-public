    ...
    () => [
      {
        ...
        desc: (
          <>
            우리는 "좋은 주인을 만나 행복해질 것"을 믿고 싶습니다.
            <br />
            하지만 데이터는 서로 다른 두 개의 62를 보여줍니다.
          </>
        ),
        links: [
      ...
      },
      {
        ...
        desc: (
          <>
            2024년 구조된 106,824마리 중 자연사+안락사 비율은 46.0%.
            <br />
            반환(약 15%)과 입양(20%대 초반)을 제외하면, "남겨짐"은 대략 62%에 가깝습니다.
          </>
        ),
        links: [
